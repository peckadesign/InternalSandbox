...
namespace Pd\InternalSandbox\Monolog\Handlers;
...
class FlashMessageHandler extends Monolog\Handler\AbstractProcessingHandler
{
	...
	protected function write(array $record)
	{
		if ($record['level'] > Monolog\Logger::WARNING) {
			$level = Pd\InternalSandbox\DashBoard\Presenters\BasePresenter::FLASH_MESSAGE_WARNING;
		} else {
			$level = Pd\InternalSandbox\DashBoard\Presenters\BasePresenter::FLASH_MESSAGE_INFO;
		}
